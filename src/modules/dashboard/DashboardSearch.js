...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      ...
      {showSearch && (
        <div className="search-result w-full lg:w-[843px] bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl">
          <div className="flex items-center justify-between p-3 bg-whiteSoft rounded-3xl">
            <h4 className="pl-4 text-sm font-medium underline text-text1">
          ...
          <div className="p-6 pb-0">
            ...
            <div className="flex flex-col text-sm cursor-pointer gap-y-3 text-text2">
              <p>
