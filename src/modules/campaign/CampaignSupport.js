...
const CampaignSupport = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col w-full px-6 bg-white rounded-lg shadow-1 py-7">
        ...
        <Input
          ...
          type="text"
          name="support"
          className="w-full px-5 py-3 mb-5 text-lg font-medium border rounded-md border-strock"
        ></Input>
        <div className="p-5 mb-5 bg-grayf3 rounded-xl">
          <p className="mb-5 text-sm font-medium text-text2">
